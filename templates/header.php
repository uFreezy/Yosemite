    ...
    <header id="header-bar">
        ...
        <h1 id="main-heading">
            <a href="#" title="Alpha-Programming">
                <?php
                echo "<a href=\"$path\"><img id=\"company-logo\" src=\"$path/assets/UI/alpha-programming-logo.png\" alt=\"alpha-programming logo\" width=\"240\" height=\"40\"/></a>";
                ?>
            </a>
        </h1>
        <!--MAIN NAVIGATION-->
        ...
        echo "<form id=\"login-form\" method=\"post\" action=\"\">
                ...
                <a href=\"templates/forgotPassword.php\" id=\"password-recovery\" title=\"recover your password\">forgotten?</a>
            ...
            echo "<div id=\"welcome-board\">
                    ...
                    <a id='logout-btn' href=\"$path\logout.php\">logout</a>
                </div>";
        }
        ?>
    </header>
